...
class Blob():
    ...
    def eat(self, population):
        """
            Allows blobs to eat, needs to be passed population
            for instances of carnivores and dendrivores finding food sources.
        ...
        if self.hunger:
            ...
            # eat another blob
                ...
                try:
                    ...
                    pass
                victim = self
                while len(population) > 1 and victim.alive is False:
    ...
    def survive(self, population):
        """
            Initiates survival process. Starts by eating (implemented as
            Blob.eat()) then moving on to other functions. You
            should call survive() rather than the individual functions
            unless you want to implement your own survival process.

            Args:
                population(list) - list of candidates that can
                be eaten by carnivores and dendrivores
